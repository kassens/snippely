Paintbrush.Brushes.CSS = {
	...
	'value': new RegExp('\\#[a-zA-Z0-9]{3,6};', 'g'),
	
	'keyword': 'ascent azimuth background-attachment background-color background-image background-position ' +
	...
	'special': 'above absolute all always aqua armenian attr aural auto avoid baseline behind below bidi-override black blink block blue bold bolder '+
